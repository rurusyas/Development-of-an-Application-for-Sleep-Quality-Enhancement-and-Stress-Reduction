...
HELP_TEXT = (
    ...
    "Косатка — не врач и не диагностический инструмент. Если что-то серьёзно "
    "беспокоит со сном или дыханием, обращайся к специалисту. Бот — про режим, "
    "рефлексию и привычки, а не про диагноз."
    "</blockquote>"
)
