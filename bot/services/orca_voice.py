...
Косатка — наш бренд-персонаж. Она плавает рядом с пользователем,
наблюдает, иногда комментирует. Тон: спокойный, тёплый, не слащавый,
немного ироничный, на «ты». Без эмодзи-спама — один-два символа на сообщение.
"""
...
_GREETINGS_EVENING = [
    ...
    "Вечер. Самое время для тёплых решений.",
...
NARR_STATS = "Что Орка увидела за неделю."
...
NARR_TIPS = "Десять карточек. Без академической вязкости — но со ссылками на источники."
